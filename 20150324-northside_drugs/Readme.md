...
1. Get code and enter project: `git clone https://github.com/striblab/20150324-northside_drugs.git && cd 20150324-northside_drugs.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150324-northside_drugs/ && rsync -rav ./ ../20150324-northside_drugs/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
