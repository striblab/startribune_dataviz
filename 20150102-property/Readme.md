...
1. Get code and enter project: `git clone https://github.com/striblab/20150102-property.git && cd 20150102-property.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150102-property/ && rsync -rav ./ ../20150102-property/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
