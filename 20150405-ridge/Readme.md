...
1. Get code and enter project: `git clone https://github.com/striblab/20150405-ridge.git && cd 20150405-ridge.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150405-ridge/ && rsync -rav ./ ../20150405-ridge/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
