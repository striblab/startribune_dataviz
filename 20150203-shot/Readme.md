# Star Tribune - St. Paul Police Shootings Data Visualization
...
1. Get code and enter project: `git clone https://github.com/striblab/20150203-shot.git && cd 20150203-shot.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150203-shot/ && rsync -rav ./ ../20150203-shot/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
