# Star Tribune - MSP airport noise over time
...
1. Get code and enter project: `git clone https://github.com/striblab/20170331-airport_noise.git && cd 20170331-airport_noise.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170331-airport_noise/ && rsync -rav ./ ../20170331-airport_noise/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
