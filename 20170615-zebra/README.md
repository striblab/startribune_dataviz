...
1. Get code and enter project: `git clone https://github.com/striblab/20170615-zebra.git && cd 20170615-zebra.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170615-zebra/ && rsync -rav ./ ../20170615-zebra/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
