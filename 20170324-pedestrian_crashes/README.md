...
1. Get code and enter project: `git clone https://github.com/striblab/20170324-pedestrian_crashes.git && cd 20170324-pedestrian_crashes.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170324-pedestrian_crashes/ && rsync -rav ./ ../20170324-pedestrian_crashes/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
