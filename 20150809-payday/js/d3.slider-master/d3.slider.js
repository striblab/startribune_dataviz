    ...
    selection.each(function() {
      ...
      if (toType(value) == "array" && value.length == 2) {
        handle1 = div.append("a")
          .classed({"d3-slider-handle" : true, "handle-one": true})
          .attr("xlink:href", "#")
          .on("click", stopPropagation)
          .call(drag);
        handle2 = div.append("a")
          .classed({"d3-slider-handle": true, "handle-two": true})
          .attr("xlink:href", "#")
          .on("click", stopPropagation)
          .call(drag);
      } else {
      ...
      function onDragHorizontal() {
        if ( d3.event.sourceEvent.target.classList.contains("handle-one")) {
          active = 1;
        } else if ( d3.event.sourceEvent.target.classList.contains( "handle-two") ) {
          active = 2;
        }
