...
1. Get code and enter project: `git clone https://github.com/striblab/20150809-payday.git && cd 20150809-payday.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150809-payday/ && rsync -rav ./ ../20150809-payday/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
