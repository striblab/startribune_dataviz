...
1. Get code and enter project: `git clone https://github.com/striblab/20150517-pain.git && cd 20150517-pain.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150517-pain/ && rsync -rav ./ ../20150517-pain/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
