# Star Tribune - Minneapolis Institute of Arts Collection Data Visualization
...
1. Get code and enter project: `git clone https://github.com/striblab/20150111-mia.git && cd 20150111-mia.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150111-mia/ && rsync -rav ./ ../20150111-mia/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
