...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20180706-ashtrees">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/20180706-ashtrees/styles.bundle.css`
      * `scripts`: `news/projects/all/20180706-ashtrees/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180706-ashtrees/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180706-ashtrees/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180706-ashtrees/",
      "url": "http://static.startribune.com/news/projects/all/20180706-ashtrees/"
    }
  }
}
```
