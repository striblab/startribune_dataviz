# Star Tribune Data Drop - MCA Test Scores 2017
...
1. Get code and enter project: `git clone https://github.com/striblab/20160726-test_scores.git && cd 20160726-test_scores.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160726-test_scores/ && rsync -rav ./ ../20160726-test_scores/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
