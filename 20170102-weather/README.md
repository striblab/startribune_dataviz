# Star Tribune - Explore Minnesota's 2015 weather
...
1. Get code and enter project: `git clone https://github.com/striblab/20170102-weather.git && cd 20170102-weather.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170102-weather/ && rsync -rav ./ ../20170102-weather/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
