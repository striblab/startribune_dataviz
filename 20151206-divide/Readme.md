...
1. Get code and enter project: `git clone https://github.com/striblab/20151206-divide.git && cd 20151206-divide.git`
...
2. Copy files (update path as needed): `mkdir -p ../20151206-divide/ && rsync -rav ./ ../20151206-divide/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
