# Star Tribune - Minnesota's Bridges

How bridges in Minnesota have been improved since the I-35W collapse. Created by [Frey Hargarten](https://github.com/jeffhargarten).
...
1. Get code and enter project: `git clone https://github.com/striblab/20170724-bridges.git && cd 20170724-bridges.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170724-bridges/ && rsync -rav ./ ../20170724-bridges/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
