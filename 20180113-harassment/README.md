...
An analysis of state sexual harassment reform.
...
```html
<div data-pym-src="http://static.startribune.com/projects/20180211-harassment">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180211-harassment/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180211-harassment/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180211-harassment/",
      "url": "http://static.startribune.com/news/projects/all/20180211-harassment/"
    }
  }
}
```
