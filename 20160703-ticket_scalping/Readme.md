...
1. Get code and enter project: `git clone https://github.com/striblab/20160703-ticket_scalping.git && cd 20160703-ticket_scalping.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160703-ticket_scalping/ && rsync -rav ./ ../20160703-ticket_scalping/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
