...
d3.json("./data/weather2017.json", function(error, dataLoad2017) {
...
data2017 = dataLoad2017.weather2017;
...
if (whatYear == '2017') { var newData = data2017; }
...
var maxTemp = Math.max.apply(Math,data2017.map(function(o){return o.Tmax;}))
var minTemp = Math.min.apply(Math,data2017.map(function(o){return o.Tmin;}))
...
var maxSnow = Math.max.apply(Math,data2017.map(function(o){return o.SnowFall;}))
var minSnow = Math.min.apply(Math,data2017.map(function(o){return o.SnowFall;}))
...
var maxPrecip = Math.max.apply(Math,data2017.map(function(o){return o.PrecipTotal;}))
var minPrecip = Math.min.apply(Math,data2017.map(function(o){return o.PrecipTotal;}))
...
var chartTempHistory = c3.generate({
        ...
        x: {
           padding: { left:0, right:0 },
            tick: {
                values: ['1895', '1924', '1953', '1982', '2017'],
                multiline: false
            }
          }
        },
...
var chartTempHot = c3.generate({
        ...
        x: {
           padding: { left:0, right:0 },
            tick: {
                values: ['1873', '1924', '1953', '1982', '2017'],
                multiline: false
            }
          }
        },
...
var chartSnowHistory = c3.generate({
       ...
       point: {
        ...
        x: {
          padding: { left:0, right:0 },
            tick: {
                values: ['1884', '1924', '1953', '1982', '2016'],
                multiline: false
            }
          }
        },
...
var chartPrecipHistory = c3.generate({
    ...
    point: {
        ...
        x: {
          padding: { left:0, right:0 },
            tick: {
                values: ['1891', '1924', '1953', '1982', '2017'],
                multiline: false
            }
          }
        },
...
var chartDewHistory = c3.generate({
        ...
        x: {
           padding: { left:0, right:0 },
            tick: {
                values: [1903, 1924, 1953, 1982, 2017],
                multiline: false
            }
          }
        },
