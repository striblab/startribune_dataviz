# Star Tribune - Minnesota Force Related Deaths from Police Actions
...
1. Get code and enter project: `git clone https://github.com/striblab/20151117-police_deaths.git && cd 20151117-police_deaths.git`
...
2. Copy files (update path as needed): `mkdir -p ../20151117-police_deaths/ && rsync -rav ./ ../20151117-police_deaths/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
