...
How tax deductions affect Minnesota counties
...
```html
<div data-pym-src="http://static.startribune.com/projects/20171215-taxes">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20171215-taxes/",
      "url": "http://static.startribune.com/news/projects-staging/all/20171215-taxes/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20171215-taxes/",
      "url": "http://static.startribune.com/news/projects/all/20171215-taxes/"
    }
  }
}
```
