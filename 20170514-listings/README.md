# Star Tribune - Metro area negative equity trends
...
1. Get code and enter project: `git clone https://github.com/striblab/20170514-listings.git && cd 20170514-listings.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170514-listings/ && rsync -rav ./ ../20170514-listings/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
