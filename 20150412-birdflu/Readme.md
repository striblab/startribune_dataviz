# Star Tribune - Avian flu spread in Minnesota
...
1. Get code and enter project: `git clone https://github.com/striblab/20150412-birdflu.git && cd 20150412-birdflu.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150412-birdflu/ && rsync -rav ./ ../20150412-birdflu/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
