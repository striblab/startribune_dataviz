...
<style>
  ...
  .deathIcon img { width:150px; height:100px; }
    ...
    .downloadButton { font-family: "Benton Sans",Helvetica,Arial,sans-serif; font-weight:bold;  color:#333333; font-size:.9em; text-align:center; margin-top:15px; margin-left:1%; width: 99%; background-color:#fff; color:#333; border-top: 1px solid #ccc;
/*
...
/*  colorbox*/
    ...
    .headlineTitle { font-size:3.2em; font-family:"Whitman Display"; font-style: normal; font-weight: bold; width:100%; text-align:center; margin:0;}
    ...
    .iconLegend { font-family:"Benton Sans"; font-size:.85em; letter-spacing: 0px; margin-bottom:10px; pointer-events:all; width:76px; border:1px solid #eee; border-radius:5px; display:inline-block; margin:1px; text-align:center; }
    ...
    .ender {position:absolute; width:10px;height:22px;border-radius:5px;top:10px;right:10px;}
   ...
   @media (max-width: 650px) {
    ...
    .tractorB { border:2px solid #b96569; }
    .landscapeB { border:2px solid #6f9a7c; }
    .otherB { border:2px solid #cf995a; }
    .siloB { border:2px solid #a17a94; }
    .skidB { border:2px solid #b1ae68; }
    .atvB { border:2px solid #76909f; }
    .truckB { border:2px solid #9c8f68; }
    .livestockB { border:2px solid #ca7a68; }
...
<a href="https://docs.google.com/spreadsheets/d/1eGWgtyT4ouwi6DKZF8rE8eTlOjTeBrk3KozImcCFNyA/pub?output=csv" target="new_"><button class="downloadButton"><img width="18" height="18" style="margin: 0px 2px 0px 0px;" src="img/downloadDoc.svg">&nbsp;Download data</button></a>
