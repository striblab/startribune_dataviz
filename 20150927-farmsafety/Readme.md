...
1. Get code and enter project: `git clone https://github.com/striblab/20150927-farmsafety.git && cd 20150927-farmsafety.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150927-farmsafety/ && rsync -rav ./ ../20150927-farmsafety/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
