...
<style>
  ...
  .breaker { clear:both; }
  .records { font-weight:900; font-family:"Popular Bold"; margin-right:auto; margin-left:auto; font-size:1.6em; display:block; width:25px; text-align:center; }
  ...
  .cartoButton { background-color:#ddd; -moz-border-radius:16px; -webkit-border-radius:16px; border-radius:0; border:0; display:inline-block; cursor:pointer; color:#000; font-family: "Benton Sans",Helvetica,Arial,sans-serif; font-size:16px; padding:10px 13px; text-decoration:none; font-weight:900; margin:2px; width:45%; }
  ...
  #victimsHeader { font-size:1.8em; float:left; clear:left; margin-top:20px; }
  ...
  .deathIcon img { width:150px; height:100px; }
    ...
    .typeIcons { width:100%; text-align:center; padding:10px; }
    .iconLegend img { width:30px; height:30px; display:block; text-align:center; margin-left:auto; margin-right:auto; }
    .hideMe { display:none; }
    .mapSide { float:left; width:55%; height:280px; display:none; }
    .mainFact { font-weight:bold; }
    .downloadButton { background-color:#ddd; color:#000; }
    .zoom { display:none; }
    #cboxLoadedContent { height:1px !important; }
    .obitzLink { font-weight:bold; padding:2px; }
    ...
    .headlineTitle { font-size:3.7em; font-family:"Whitman Display Compressed Bold"; width:100%; text-align:center; }
    .chatterTop { font-family:"Benton Sans"; text-align:center; margin:18px; }
    #eachDeath { display:none; }
    .section { margin-left:auto; margin-right:auto; border-top:1px solid #ddd; border-right:1px solid #ddd; border-left:1px solid #ddd; width:95% !important; }
    
    .iconLegend { font-family:"Benton Sans"; margin-bottom:10px; pointer-events:all; width:100px; border:1px solid #ddd; border-radius:5px; display:inline-block; padding:1px; text-align:center; }
    .iconLegend:hover { background-color:#333 !important; cursor:pointer; color:#fff; }
    .records { font-family:"Benton Sans"; font-weight:normal; }
    .deathSwatch { background-color:#999999; color:white; border-color:#999999; }
    .atvSwatch { background-color:#76909f; color:white; border-color:#76909f; }
    .siloSwatch { background-color:#a17a94; color:white; border-color:#a17a94; }
    .landscapeSwatch { background-color:#6f9a7c; color:white; border-color:#6f9a7c; }
    .livestockSwatch { background-color:#ca7a68; color:white; border-color:#ca7a68; }
    .skidSwatch { background-color:#b1ae68; color:white; border-color:#b1ae68; }
    .truckSwatch { background-color:#9c8f68; color:white; border-color:#9c8f68; }
    .tractorSwatch { background-color:#b96569; color:white; border-color:#b96569; }
    .otherSwatch { background-color:#cf995a; color:white; border-color:#cf995a; }
    .desaturate { background-color:#eee; border-color:#eee; color:#000; }
    .records:hover { cursor:pointer; pointer-events:all; }
    #sliderDiv { display:none; }
    .yearIcon { width:70px; padding:3px; background-color:#ddd; font-family:"Benton Sans"; display:inline-block; margin:2px; border-radius:5px; }
    .yearIcon:hover { background-color:#333; color:#fff; cursor:pointer; }
    .yearSelected { background-color:#333; color:#fff; }
    
     .breakerTop { clear:both; padding:20px; margin:10px; }

    #leftSide { float:left; width:70% !important; display:block; }
    .typeIcon { width:130px; float:left; height:130px; margin-right:20px; margin-left:20px; }
    .types { height:auto; }
    .types h2 { font-weight:900; font-family:"Benton Sans"; font-size:1.8em; }
    .deathHeader { float:left; }
    .deathChatter { width:60%; min-height:145px; display:inline-block; }
    #map { height:230px; width:180px; float:right; margin-top:25px; }
    #filter input:focus { box-shadow: 0 0 5px #61bd1a; padding: 3px 0px 3px 3px; border: 1px solid #61bd1a; }
    #filter input { border-radius:5px !important; margin:0; width:100%; height:30px; line-height:120%; font-size: 1em; -webkit-appearance: none;
    ...
    .victimCard { font-family:"Benton Sans"; width:30%; border-radius:5px; height:auto; background:#ddd; display:inline-block; margin:5px; padding:10px; }
    .victimCard:hover { cursor:pointer; opacity:.5; }
    .victimName { font-size:1.1em; font-family:"Benton Sans"; font-weight:900; }
    .victimAge { font-size:1.3em; font-family:"Benton Sans"; font-weight:normal; }
...
<div id="mobileHeader">Minnesota farm accidents resulting in death, 2004-2015</div>

<div class="headlineTitle">A DECADE OF DEADLY FARMING</div>
<!-- take this line --><div class="chatterTop" id="topChatter">Farming is one of the most dangerous occupations in the country, and farming deaths are on the rise in Minnesota:  Federal records show deaths in farming accidents up 30 percent from the previous decade. Explore this Star Tribune database, built by reviewing accident reports back to 2004, to learn more about the incidents and the victims.</div>

<div class="chatterTop section">SORT BY ACCIDENT TYPE AND YEAR KILLED</div>

<div class="sectionBlock" id="mnDeaths">
  <div class="typeIcons">
    <div class="iconLegend allB deathSwatch" icon="all" rel="deathSwatch">All<div id="recordsAll" class="recordsAll records">211</div></div>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-all-icons.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <!-- take this line --><p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, about <span class="deathSwatch recordsAll">211</span> Minnesotans have died in farm-related accidents involving various types of vehicles, heavy machinery and other hazards.</p>
<!--     <p class="chatter">Minnesota suffered the most <span class="deathSwatch">farm-related deaths</span> in the Midwest and ranks highly in <span class="deathSwatch">fatal farm accidents</span> nationally. While <span class="deathSwatch">deadly farm accidents</span> decreased in most states between the last two decades, in Minnesota they <span class="deathSwatch">increased 37 percent</span>.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-atv-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsATV atvSwatch"></span> ATV-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-silo-icon.svg
" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsSilo siloSwatch"></span> grain bin or silo-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-landscape-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsEnvironmental landscapeSwatch"></span> landscape-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-livestock-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsLivestock livestockSwatch"></span> livestock-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-skid-loader-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsSkid skidSwatch"></span> skid loader-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-truck-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsTruck truckSwatch"></span> truck-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-tractor-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsTractor tractorSwatch"></span> tractor-related farm deaths.</p>
...
<div class="deathHeader"><img class="typeIcon" src="http://static.startribune.com.s3.amazonaws.com/news/newsgraphics/local/farms-100415/icons/farm-other-icon.svg" /></div>
  <div class="mapSide"></div>
  <div class="deathChatter">
    <p class="mainFact"><span class="thisYear">From 2004 to 2014</span>, there were <span class="recordsOther otherSwatch"></span> other farm deaths.</p>
...
$(".yearIcon").click(function() {
  ...
  //this line
  if (Number($(this).attr("rel")) == 2003) { 
    $(".thisYear").html("From 2004 to 2015"); 
...
function shiftchart(year) {
  ...
  $( ".allB" ).click(function() {
    //this line
    // restoreMarkers(deathsLayer,$(".yearIcon").find(".yearSelected").attr("rel"));
    console.log(year);
...
d3.select('#slider').call(slider.min(2003).max(2014).value(2003).axis(d3.svg.axis().tickFormat(d3.format("")).orient("top").ticks(tickLength)).step(1).on("slide", function(evt, value) {
  ...
  drawChart("" + value + "");
  drawCards("" + value + "","");
  if (value == 2003) { $(".thisYear").html("From 2004 to 2015"); }
...
if (type == "all"){
  ...
  .html(function (d,i){
    ...
    var dateString = (new Date(d.date_of_death).getMonth() + 1) + "/" + (new Date(d.date_of_death).getDay() + 1) + "/" + new Date(d.date_of_death).getFullYear();
    return "<span class='victimName'>" + d.victim_name + "</span> - <span class='victimAge'>" + d.victim_age + "</span><div class='deathDate'>Died: " + dateString + " in " + d.injury_city + "</div><div class='ender " + icon + "'></div>"; });
}
  else {
  d3.select("#victims").selectAll("button")
  ...
  .on("mousedown", function(d, i){
    var dateString = (new Date(d.date_of_death).getMonth() + 1) + "/" + (new Date(d.date_of_death).getDay() + 1) + "/" + new Date(d.date_of_death).getFullYear();
     ...
     //  detailsBox.style("display","block");
      // detailsBox.html("<span class='victimName'>" + d.victim_name + "</span> - <span class='victimAge'>" + d.victim_age + "</span><div class='deathMode'>Killed in " + d.death_icon + " accident</div><div class='deathDate'>Died on " + dateString + "</div><div class='deathIcon'>" + icon + "</div><div class='howDied'>Died from " + d.cause_of_death + "</div><div class='details'>" + d.incident_description + "</div>")
       $('#victims_nerdbox, #cboxContent').html("<span class='victimName'>" + d.victim_name + "</span> - <span class='victimAge'>" + d.victim_age + "</span><div class='deathMode'>Killed in " + d.death_icon + " accident</div><div class='deathDate'>Died on " + dateString + "</div><div class='howDied'>Died from " + d.cause_of_death + "</div><div class='details'>" + d.incident_description + "</div>" + "</div><div class='obitzLink'><a href='" +  d.obituary + "' target='new_'>Read obituary</div>");
       $(".inline").colorbox({inline:true, closeButton:true, width:"70%", height:"500px"});
     })
  .html(function (d,i){
       var icon = "<img src='img/other.png' />";
  ...
  .on("mousedown", function(d, i){
    var dateString = (new Date(d.date_of_death).getMonth() + 1) + "/" + (new Date(d.date_of_death).getDay() + 1) + "/" + new Date(d.date_of_death).getFullYear();
      ...
      // detailsBox.style("display","block");
      // detailsBox.html("<span class='victimName'>" + d.victim_name + "</span> - <span class='victimAge'>" + d.victim_age + "</span><div class='deathMode'>Killed in " + d.death_icon + " accident</div><div class='deathDate'>Died on " + dateString + "</div><div class='deathIcon'>" + icon + "</div><div class='howDied'>Died from " + d.cause_of_death + "</div><div class='details'>" + d.incident_description + "</div>")
       $('#victims_nerdbox, #cboxContent').html("<span class='victimName'>" + d.victim_name + "</span> - <span class='victimAge'>" + d.victim_age + "</span><div class='deathMode'>Killed in " + d.death_icon + " accident</div><div class='deathDate'>Died on " + dateString + "</div><div class='howDied'>Died from " + d.cause_of_death + "</div><div class='details'>" + d.incident_description + "</div>" + "</div><div class='obitzLink'><a href='#link' target='new_'>Read obituary</div>");
       $(".inline").colorbox({inline:true, closeButton:true, width:"70%", height:"500px"});
     })
  .html(function (d){
       var icon = "<img src='img/other.png' />";
