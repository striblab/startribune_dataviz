...
1. Get code and enter project: `git clone https://github.com/striblab/20160616-eat_duluth.git && cd 20160616-eat_duluth.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160616-eat_duluth/ && rsync -rav ./ ../20160616-eat_duluth/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
