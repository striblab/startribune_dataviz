...
1. Get code and enter project: `git clone https://github.com/striblab/<THISFOLDER>.git && cd <THISFOLDER>.git`
...
2. Copy files (update path as needed): `mkdir -p ../<THISFOLDER>/ && rsync -rav ./ ../<THISFOLDER>/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
