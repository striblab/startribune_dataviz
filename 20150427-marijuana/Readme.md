...
1. Get code and enter project: `git clone https://github.com/striblab/20150427-marijuana.git && cd 20150427-marijuana.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150427-marijuana/ && rsync -rav ./ ../20150427-marijuana/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
