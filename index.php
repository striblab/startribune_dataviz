...
<!-- dataviz and custom styles for this page -->
   <style>
      ...
      #leftPane { float:left !important; width:65% !important; }
      #infobox { font-size:16px; margin:10px; }
      #infobox p { padding:3px; }
      #logo_container { width:35%; }
...
/*page template styles*/
    ...
    .articlePhoto img { max-width:100%; max-height:250px !important; }
...
<div id="links">
<div class="link"><a href="http://www.startribune.com/local/blogs/Full_Disclosure/" target="new_"><img src="img/fulldisclosure-color.png" class="bloglogo" /> Full Disclosure Blog</a></div>
