...
1. Get code and enter project: `git clone https://github.com/striblab/20161214-traffic_stops.git && cd 20161214-traffic_stops.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161214-traffic_stops/ && rsync -rav ./ ../20161214-traffic_stops/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
