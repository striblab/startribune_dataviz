...
1. Get code and enter project: `git clone https://github.com/striblab/20170305-housing_recovery.git && cd 20170305-housing_recovery.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170305-housing_recovery/ && rsync -rav ./ ../20170305-housing_recovery/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
