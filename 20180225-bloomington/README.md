...
```html
<div data-pym-src="http://static.startribune.com/projects/20180225-bloomington">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180225-bloomington/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180225-bloomington/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180225-bloomington/",
      "url": "http://static.startribune.com/news/projects/all/20180225-bloomington/"
    }
  }
}
```
...
Built using [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) and [jQuery](https://github.com/jquery/jquery).
