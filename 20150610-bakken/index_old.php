<?php
	...
	$shareURL = "http://apps.startribune.com/news/20150610-bakken/index.php";
...
@font-face {
  ...
  /*dataviz styles*/
    ...
    .f-nav{ z-index: 9999; position: fixed; left: 0; top: 50px; width: 100%;}
...
<div id='legendCircle' style='float:right;'>
...
<div id='training' class="anchor"></div>
  ...
  <div id='map2'><svg width="100%" height="400" viewBox="0 0 800 400" preserveAspectRatio="xMidYMid"></svg></div>
...
<div id='map4'><svg width="100%" height="400" viewBox="0 0 800 400" preserveAspectRatio="xMidYMid"></svg></div>
...
nv.addGraph(function() {
    chart1 = nv.models.multiBarChart()
      ...
      .margin({top: 30, right: 5, bottom: 80, left: 20})
