...
1. Get code and enter project: `git clone https://github.com/striblab/20150610-bakken.git && cd 20150610-bakken.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150610-bakken/ && rsync -rav ./ ../20150610-bakken/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
