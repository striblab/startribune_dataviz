# Star Tribune Data Drop - Philando Castile Traffic Stops Timeline
...
1. Get code and enter project: `git clone https://github.com/striblab/20160714-castile_timeline.git && cd 20160714-castile_timeline.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160714-castile_timeline/ && rsync -rav ./ ../20160714-castile_timeline/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
