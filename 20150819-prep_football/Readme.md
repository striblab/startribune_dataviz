...
1. Get code and enter project: `git clone https://github.com/striblab/20150819-prep_football.git && cd 20150819-prep_football.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150819-prep_football/ && rsync -rav ./ ../20150819-prep_football/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
