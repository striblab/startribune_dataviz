# Star Tribune - Metro area affordable rentals
...
1. Get code and enter project: `git clone https://github.com/striblab/20170407-rental_housing.git && cd 20170407-rental_housing.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170407-rental_housing/ && rsync -rav ./ ../20170407-rental_housing/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
