# Star Tribune - Measuring up on Medicaid fraud
...
1. Get code and enter project: `git clone https://github.com/striblab/20141228-mfcu.git && cd 20141228-mfcu.git`
...
2. Copy files (update path as needed): `mkdir -p ../20141228-mfcu/ && rsync -rav ./ ../20141228-mfcu/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
