...
1. Get code and enter project: `git clone https://github.com/striblab/20150220-nightsky.git && cd 20150220-nightsky.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150220-nightsky/ && rsync -rav ./ ../20150220-nightsky/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
