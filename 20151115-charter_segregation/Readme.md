...
1. Get code and enter project: `git clone https://github.com/striblab/20151115-charter_segregation.git && cd 20151115-charter_segregation.git`
...
2. Copy files (update path as needed): `mkdir -p ../20151115-charter_segregation/ && rsync -rav ./ ../20151115-charter_segregation/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
