# Star Tribune - Measuring Met Council Impact
...
1. Get code and enter project: `git clone https://github.com/striblab/20170521-metcouncil.git && cd 20170521-metcouncil.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170521-metcouncil/ && rsync -rav ./ ../20170521-metcouncil/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
