...
An analysis of Minnesota Legacy outdoors funding over time. Built using [Mapbox](https://github.com/mapbox/mapbox-gl-js).
...
```html
<div data-pym-src="http://static.startribune.com/projects/legacy">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/legacy/",
      "url": "http://static.startribune.com/news/projects-staging/all/legacy/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/legacy/",
      "url": "http://static.startribune.com/news/projects/all/legacy/"
    }
  }
}
```
