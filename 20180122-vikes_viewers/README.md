# Star Tribune - 2017 NFC Championship viewership throughout the game
...
1. Get code and enter project: `git clone https://github.com/striblab/20180122-vikes_viewers.git && cd 20180122-vikes_viewers.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180122-vikes_viewers/ && rsync -rav ./ ../20180122-vikes_viewers/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
