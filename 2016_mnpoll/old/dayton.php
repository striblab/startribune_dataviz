...
<div id='legend'>
<h4>Do you approve or disapprove of Mark Dayton’s job performance as governor?</h4>
  <nav class='legend clearfix'>
    <div class="leg"><span style='color:#49803F;font-size:52px;line-height:35%;'>&#8226;</span> <label>&nbsp;Approve</label></div>
<p></p>
    <div class="leg"><span style='color:#6D9966;font-size:52px;line-height:35%;'>&#8226;</span> <label>&nbsp;Disapprove</label></div>
<p></p>
    <div class="leg"><span style='color:#92B28D;font-size:52px;line-height:35%;'>&#8226;</span> <label>&nbsp;Undecided</label></div>
</nav>
</div>
...
<div id="bigPie">
  ...
  <div id="highlight"><h1 id="bigNum">54%</h1><span id="whatWhat" style="color:#666">approve</span>
      <h1 id="bigNum" style="margin-top:6px;">36%</h1><span id="whatWhat" style="color:#666">disapprove</span></div>
...
<p></p><p></p>
<div class="quadpie">
<div id="pie2" style="float:left;"><div id="demo1">Demo1</div><svg style="height:200px;width:200px;"></svg></div><div id="pie3" style="float:left;"><div id="demo2">Demo2</div><svg style="height:200px;width:200px;"></svg></div>
</div>
<div class="quadpie">
<div id="pie4" style="float:left;"><div id="demo3">Demo3</div><svg style="height:200px;width:200px;"></svg></div><div id="pie5" style="float:left;"><div id="demo4">Demo4</div><svg style="height:200px;width:200px;"></svg></div>
</div>
</div>
<div class="clearfix"></div>
<div id="bars">
<span id="q4"><h5>In a public falling out with his party’s Senate Majority Leader, Governor Dayton said Tom Bakk had “stabbed me in the back.” The two DFL leaders recently made public amends. Which comes closest to your view of this incident:  1.) I like that Dayton speaks his mind, 2.) Dayton should have kept his differences with Bakk private, 3.) Dayton overreacted
</h5></span>
...
redrawGraph = function(data1, data2, data3, data4, data5, data6, data7, data8, theline) {
    ...
    var d1Text= [
     ...
     'What respondents making less than $50,000 said',
     'What respondents living in Hennepin/Ramsey counties said',
     'What men said',
    ...
    var d2Text= [
     "What Republicans said",
      "What respondents making more than $50,000 said",
      "What respondents living in the rest of the metro area said",
     "What women said",
    ...
    var d3Text= [
     ...
     " ",
     "What respondents living in the rest of State said",
     " ",
