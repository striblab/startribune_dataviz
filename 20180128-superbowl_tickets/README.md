...
```html
<div data-pym-src="http://static.startribune.com/projects/superbowl-tickets">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/superbowl-tickets/",
      "url": "http://static.startribune.com/news/projects-staging/all/superbowl-tickets/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/superbowl-tickets/",
      "url": "http://static.startribune.com/news/projects/all/superbowl-tickets/"
    }
  }
}
```
