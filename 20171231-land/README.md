...
```html
<div data-pym-src="http://static.startribune.com/projects/20171231-land">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20171231-land/",
      "url": "http://static.startribune.com/news/projects-staging/all/20171231-land/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20171231-land/",
      "url": "http://static.startribune.com/news/projects/all/20171231-land/"
    }
  }
}
```
