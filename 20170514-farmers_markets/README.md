...
1. Get code and enter project: `git clone https://github.com/striblab/20170514-farmers_markets.git && cd 20170514-farmers_markets.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170514-farmers_markets/ && rsync -rav ./ ../20170514-farmers_markets/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
