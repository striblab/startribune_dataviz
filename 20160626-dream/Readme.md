# Star Tribune - DREAM Project Map
...
1. Get code and enter project: `git clone https://github.com/striblab/20160626-dream.git && cd 20160626-dream.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160626-dream/ && rsync -rav ./ ../20160626-dream/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
