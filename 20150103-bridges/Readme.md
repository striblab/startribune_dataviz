# Star Tribune - Worst Bridges in Minnesota Data Visualization
...
1. Get code and enter project: `git clone https://github.com/striblab/20150103-bridges.git && cd 20150103-bridges.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150103-bridges/ && rsync -rav ./ ../20150103-bridges/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
