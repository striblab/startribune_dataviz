...
1. Get code and enter project: `git clone https://github.com/striblab/20140714-smoking.git && cd 20140714-smoking.git`
...
2. Copy files (update path as needed): `mkdir -p ../20140714-smoking/ && rsync -rav ./ ../20140714-smoking/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
