# Star Tribune Data Drop - Surging popularity of Mohamed
...
2. Copy files (update path as needed): `mkdir -p ../20180109-mohamed/ && rsync -rav ./ ../20180109-mohamed/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
