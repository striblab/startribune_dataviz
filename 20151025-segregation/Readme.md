# Star Tribune - Minnesota School Segregation
...
1. Get code and enter project: `git clone https://github.com/striblab/20151025-segregation.git && cd 20151025-segregation.git`
...
2. Copy files (update path as needed): `mkdir -p ../20151025-segregation/ && rsync -rav ./ ../20151025-segregation/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
