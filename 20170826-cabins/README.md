# Star Tribune - Taxation of Minnesota cabins
...
1. Get code and enter project: `git clone https://github.com/striblab/20170826-cabins.git && cd 20170826-cabins.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170826-cabins/ && rsync -rav ./ ../20170826-cabins/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
