# Star Tribune - Sports schedule overlaps
...
1. Get code and enter project: `git clone https://github.com/striblab/20160812-sports_overlap.git && cd 20160812-sports_overlap.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160812-sports_overlap/ && rsync -rav ./ ../20160812-sports_overlap/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
3. Update the relevant deployment repo.

## Credits

Built using [Google Charts](https://github.com/GoogleWebComponents/google-chart) and [jQuery](https://github.com/jquery/jquery).