...
1. Get code and enter project: `git clone https://github.com/striblab/20141005-cps-flowchart.git && cd 20141005-cps-flowchart.git`
...
2. Copy files (update path as needed): `mkdir -p ../20141005-cps-flowchart/ && rsync -rav ./ ../20141005-cps-flowchart/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
