# Star Tribune - Metro area population growth
...
1. Get code and enter project: `git clone https://github.com/striblab/20150520-census.git && cd 20150520-census.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150520-census/ && rsync -rav ./ ../20150520-census/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
