# Star Tribune - Minnesota Open Enrollment Migrations
...
1. Get code and enter project: `git clone https://github.com/striblab/open_enrollment.git && cd open_enrollment.git`
...
2. Copy files (update path as needed): `mkdir -p ../open_enrollment/ && rsync -rav ./ ../open_enrollment/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
