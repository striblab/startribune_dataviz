...
1. Get code and enter project: `git clone https://github.com/striblab/20170917-infuse.git && cd 20170917-infuse.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170917-infuse/ && rsync -rav ./ ../20170917-infuse/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
