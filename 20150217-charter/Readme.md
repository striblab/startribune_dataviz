...
1. Get code and enter project: `git clone https://github.com/striblab/20150217-charter.git && cd 20150217-charter.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150217-charter/ && rsync -rav ./ ../20150217-charter/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
