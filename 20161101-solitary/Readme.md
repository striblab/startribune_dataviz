# Star Tribune - Solitary Confinement in Minnesota Prisons
...
1. Get code and enter project: `git clone https://github.com/striblab/20161101-solitary.git && cd 20161101-solitary.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161101-solitary/ && rsync -rav ./ ../20161101-solitary/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
