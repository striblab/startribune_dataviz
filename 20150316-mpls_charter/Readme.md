# Star Tribune - Where Minneapolis kids go to school outside their district
...
1. Get code and enter project: `git clone https://github.com/striblab/20150316-mpls_charter.git && cd 20150316-mpls_charter.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150316-mpls_charter/ && rsync -rav ./ ../20150316-mpls_charter/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
