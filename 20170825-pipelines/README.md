# Star Tribune - Enbridge Pipeline Spills
...
1. Get code and enter project: `git clone https://github.com/striblab/20170825-pipelines.git && cd 20170825-pipelines.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170825-pipelines/ && rsync -rav ./ ../20170825-pipelines/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
