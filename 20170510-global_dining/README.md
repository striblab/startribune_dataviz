# Star Tribune - Global Dining in Minneapolis
...
1. Get code and enter project: `git clone https://github.com/striblab/20170510-global_dining.git && cd 20170510-global_dining.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170510-global_dining/ && rsync -rav ./ ../20170510-global_dining/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
