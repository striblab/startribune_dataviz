...
1. Get code and enter project: `git clone https://github.com/striblab/20180212-housing.git && cd 20180212-housing.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180212-housing/ && rsync -rav ./ ../20180212-housing/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
