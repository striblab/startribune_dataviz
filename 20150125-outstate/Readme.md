# Star Tribune - Metro vs. outstate: Which counties pay most taxes and which get most aid?
...
1. Get code and enter project: `git clone https://github.com/striblab/20150125-outstate.git && cd 20150125-outstate.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150125-outstate/ && rsync -rav ./ ../20150125-outstate/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
