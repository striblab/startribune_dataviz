    <?php $server_path = "http://apps.startribune.com/news/" ?>
...
/*page template styles*/
    #specialContentWrapper{ margin-top:50px; width:100% !important; }
...
/*    .nav-menu .menu-left, .nav-menu .menu-right { visibility:hidden !important; display:none !important; }*/
    ...
    .sections-menu-container .block-list li a:link, .nav-menu h5, .additional-links-container .block-list li a:link { font-weight: 900; font-size: 1.3em; }
    .milli { font-weight: 900; }
