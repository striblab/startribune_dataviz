...
1. Get code and enter project: `git clone https://github.com/striblab/20150613-greenline.git && cd 20150613-greenline.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150613-greenline/ && rsync -rav ./ ../20150613-greenline/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
