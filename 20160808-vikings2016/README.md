...
1. Get code and enter project: `git clone https://github.com/striblab/20160808-vikings2016.git && cd 20160808-vikings2016.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160808-vikings2016/ && rsync -rav ./ ../20160808-vikings2016/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
