# Star Tribune Data Drop - U.S. Bank Stadium labor hours by trade
...
1. Get code and enter project: `git clone https://github.com/striblab/20160702-usbank_stadium.git && cd 20160702-usbank_stadium.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160702-usbank_stadium/ && rsync -rav ./ ../20160702-usbank_stadium/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
