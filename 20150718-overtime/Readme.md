# Star Tribune - Metro Area County Overtime Pay Database
...
1. Get code and enter project: `git clone https://github.com/striblab/20150718-overtime.git && cd 20150718-overtime.git`
...
2. Copy files (update path as needed): `mkdir -p ../20150718-overtime/ && rsync -rav ./ ../20150718-overtime/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
