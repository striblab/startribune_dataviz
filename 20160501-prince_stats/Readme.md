# Star Tribune - Key events in Prince's life
...
1. Get code and enter project: `git clone https://github.com/striblab/20160501-prince_stats.git && cd 20160501-prince_stats.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160501-prince_stats/ && rsync -rav ./ ../20160501-prince_stats/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
